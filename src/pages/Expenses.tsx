...
import { Loader2, Receipt, Wallet, Banknote, History, CheckCircle2, AlertCircle, PlusCircle } from 'lucide-react';
                            ...
                            <div className="border border-slate-300 bg-white">
                                <div className="bg-slate-900 px-6 py-3 flex items-center justify-between">
                                    ...
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="h-7 text-[9px] font-black text-slate-400 hover:text-white hover:bg-slate-800 rounded-none border border-slate-700 uppercase tracking-widest gap-1"
                                        onClick={() => setIsAddModalOpen(true)}
                                    >
                                        <PlusCircle className="h-3 w-3" /> New Category
                                    </Button>
                                </div>
