-- =================================================================
-- FINAL ACCURATE BALANCE SHEET FIX (Tag-Neutral + Opening Balance)
-- Purpose: Ensures Balance Sheet matches Ledger Statement exactly
-- =================================================================
...
BEGIN
    ...
    -- Logic: If (Opening + Ledger Dr - Ledger Cr) > 0
    ...
    -- Logic: If (Opening + Ledger Dr - Ledger Cr) < 0
    -- Both Sami and Sabir will show here if their net is negative
